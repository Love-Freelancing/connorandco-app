        ...
        if (isApprove) {
          ...
          try {
            ...
            await confirmSuggestedMatch(db, {
              ...
              inboxId,
              transactionId,
              userId: undefined, // Slack interactions don't have Connor & Co user ID mapping
              teamId,
            });
                    ...
                    elements: [
                      {
                        ...
                        url: `https://app.connorandco.vercel.app/transactions?id=${encodeURIComponent(transactionId)}`,
                ...
                blocks: [
                  {
                    ...
                    text: {
                      type: "mrkdwn",
                      text: "❌ *Match declined*\n\nThe suggestion has been dismissed. You can manually match this receipt in Connor & Co.",
                    },
                  },
                  {
                    type: "actions",
                    elements: [
                      {
                        ...
                        url: `https://app.connorandco.vercel.app/inbox?inboxId=${encodeURIComponent(inboxId)}`,
