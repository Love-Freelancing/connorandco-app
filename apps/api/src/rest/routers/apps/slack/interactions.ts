                    ...
                    elements: [
                      {
                        ...
                        url: `https://app.app.connorco.dev/transactions?id=${encodeURIComponent(transactionId)}`,
                    ...
                    elements: [
                      {
                        ...
                        url: `https://app.app.connorco.dev/inbox?inboxId=${encodeURIComponent(inboxId)}`,
