...
const GITHUB_REPO = "connorandco-ai/connorandco";
...
const downloadQuerySchema = z.object({
  url: z
    ...
    .openapi({
      ...
      example:
        "https://github.com/connorandco-ai/connorandco/releases/download/connorandco-v1.0.0/Connor & Co.app.tar.gz",
      param: {
        in: "query",
        name: "url",
        required: true,
...
function getGitHubHeaders(): Record<string, string> {
  const headers: Record<string, string> = {
    "User-Agent": "Connor & Co-Desktop-Updater",
  };
...
app.openapi(
  createRoute({
    ...
    description:
      "Proxies the download of a desktop app update artifact from GitHub releases. Only URLs pointing to the connorandco-ai/connorandco repository are accepted.",
    tags: ["Desktop"],
    request: {
