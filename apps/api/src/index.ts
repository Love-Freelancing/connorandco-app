...
import { closeSharedRedisClient } from "@connorco/cache/shared-redis";
import { closeDb } from "@connorco/db/client";
import {
  buildDependenciesResponse,
  buildReadinessResponse,
  checkDependencies,
} from "@connorco/health/checker";
import { apiDependencies } from "@connorco/health/probes";
...
app.doc("/openapi", {
  ...
  info: {
    ...
    license: {
      ...
      url: "https://github.com/connorandco-ai/connorandco/blob/main/LICENSE",
    },
  },
  servers: [
    {
...
app.openAPIRegistry.registerComponent("securitySchemes", "token", {
  ...
  "x-speakeasy-example": "CONNORCO_API_KEY",
});

app.get(
  "/",
  Scalar({ url: "/openapi", pageTitle: "Connor & Co API", theme: "saturn" }),
);
