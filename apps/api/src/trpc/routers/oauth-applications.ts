...
import { AppInstalledEmail } from "@connorco/email/emails/app-installed";
import { AppReviewRequestEmail } from "@connorco/email/emails/app-review-request";
      ...
      if (input.status === "pending") {
        try {
          ...
          if (currentTeam && session.user.email) {
            ...
            await resend.emails.send({
              from: "Connor & Co <connor@connorandco.vercel.app>",
              to: "pontus@connorandco.vercel.app",
