...
import { isValidTimezone } from "@connorco/location/timezones";
...
export const draftInvoiceResponseSchema = z
  .object({
    ...
    pdfUrl: z.string().nullable().openapi({
      ...
      example: "https://app.connorco.dev/api/download/invoice?token=eyJ...",
    }),
    previewUrl: z.string().nullable().openapi({
      description: "Direct URL to preview the invoice in browser",
      example: "https://app.connorco.dev/i/eyJ...",
    }),
  })
  .openapi({
...
export const invoiceResponseSchema = z
  .object({
    ...
    pdfUrl: z.string().url().nullable().openapi({
      ...
      example:
        "https://app.connorco.dev/api/download/invoice?token=eef58951-1682-4062-b010-425866032390",
    }),
    previewUrl: z.string().url().nullable().openapi({
      description:
        "URL to preview the invoice in the browser, or null if not generated",
      example: "https://app.connorco.dev/i/eef58951-1682-4062-b010-425866032390",
    }),
  })
  .openapi({
