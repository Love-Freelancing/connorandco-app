        ...
        connection: z
          .object({
            ...
            logoUrl: z.string().nullable().openapi({
              ...
              example: "https://cdn.app.connorco.dev/logos/chase-bank.png",
            }),
          })
          .openapi({
            description:
            ...
            example: {
              ...
              name: "Chase Bank",
              logoUrl: "https://cdn.app.connorco.dev/logos/chase-bank.png",
            },
          }),
      })
      .openapi({
...
export const transactionAttachmentPreSignedUrlResponseSchema = z.object({
  url: z.string().url().openapi({
    ...
    example:
      "https://service.app.connorco.dev/storage/v1/object/sign/vault/transactions/receipt.pdf?token=abc123&expires=1640995200",
  }),
