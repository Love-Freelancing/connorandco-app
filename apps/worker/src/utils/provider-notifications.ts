...
import { sendMatchNotification } from "@connorco/app-store/whatsapp/server";
        ...
        blocks: [
          {
            ...
            text: {
              type: "mrkdwn",
              text: "You got some new transactions! We'll do our best to match these with receipts in your Inbox or you can simply upload them in your <slack://app?id=A07PN48FW3A|Connor & Co Assistant>.",
            },
          },
          { type: "divider" },
            ...
            elements: [
              {
                ...
                url: "https://app.connorco.dev/transactions",
