...
import type { InsightMetric } from "@connorco/db/schema";
import {
  ...
  getPeriodLabel,
  type PeriodType,
} from "@connorco/insights";
import {
  buildAudioUrl,
  createAudioToken,
  isAudioTokenEnabled,
} from "@connorco/insights/audio";
import { triggerJob } from "@connorco/job-client";
import { getApiUrl } from "@connorco/utils/envs";
 ...
 *
 * This processor uses @connorco/insights to:
