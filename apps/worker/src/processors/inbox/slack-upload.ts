...
import {
  ...
  downloadFile,
  ensureBotInChannel,
} from "@connorco/app-store/slack-client";
import {
  createInbox,
...
import { DocumentClient } from "@connorco/documents";
import { triggerJob, triggerJobAndWait } from "@connorco/job-client";
import { createClient } from "@connorco/supabase/job";
import { getExtensionFromMimeType } from "@connorco/utils";
            ...
            elements: [
              {
                ...
                url: `https://app.connorco.dev/inbox?inboxId=${encodeURIComponent(updatedInbox.id)}`,
