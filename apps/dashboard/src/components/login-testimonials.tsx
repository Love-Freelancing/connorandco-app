...
const testimonials = [
  ...
  },
  {
    ...
    content:
      "Without Connor & Co I would've sold my company and lost loads of money. I never had the time to learn Quickbooks or Xero so had no idea what the company cash was doing without ringing up my accountant.",
    highlighted:
      "Without Connor & Co I would've sold my company and lost loads of money",
    firstPart:
      "Without Connor & Co I would've sold my company and lost loads of money",
    secondPart:
  ...
  },
  {
    ...
    content:
      "I prefer to have one tool for finances, similar to what Deel is for HR. Connor & Co helped me find a compromise with my tax advisor: I'm not using one of his supported clunky tools but an actually UX-friendly tool and can provide him with acceptable .csv. That's a big one!",
    highlighted:
      "I prefer to have one tool for finances, similar to what Deel is for HR",
    firstPart:
      "I prefer to have one tool for finances, similar to what Deel is for HR",
    secondPart:
      ". Connor & Co helped me find a compromise with my tax advisor: I'm not using one of his supported clunky tools but an actually UX-friendly tool and can provide him with acceptable .csv. That's a big one!",
  },
];
