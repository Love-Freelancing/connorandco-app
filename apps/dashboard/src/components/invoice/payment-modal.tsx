...
import { fromStripeAmount } from "@connorco/invoice/currency";
import { Button } from "@connorco/ui/button";
import { cn } from "@connorco/ui/cn";
import { Drawer, DrawerContent } from "@connorco/ui/drawer";
import { useMediaQuery } from "@connorco/ui/hooks";
...
export function PaymentModal({
  ...
  const initializePayment = async () => {
    ...
    try {
      const apiUrl = process.env.NEXT_PUBLIC_API_URL || "https://api.connorandco.vercel.app";
