        ...
        <SheetContent>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <span className="text-xs text-[#878787]">
                    {category} • Published by Connor & Co
                  </span>
                </div>
              </div>
          ...
          <div className="absolute bottom-4 pt-8 border-t border-border">
            <p className="text-[10px] text-[#878787]">
              ...
              peer-reviewed. Connor & Co Labs AB maintains high standards but doesn't
              endorse third-party apps. Apps published by Connor & Co are officially
