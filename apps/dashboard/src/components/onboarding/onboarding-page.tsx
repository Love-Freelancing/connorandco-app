...
import { LogEvents } from "@connorco/events/events";
import { BulkReconciliationAnimation } from "@connorco/ui/animations/bulk-reconciliation";
import { ReceiptAttachmentAnimation } from "@connorco/ui/animations/receipt-attachment";
import { WidgetsAnimation } from "@connorco/ui/animations/widgets";
...
function DashboardImageAnimation() {
  return (
    ...
    >
      <Image
        src="https://cdn.connorandco.vercel.app/web/dashboard-light.svg"
      ...
      />
      <Image
        src="https://cdn.connorandco.vercel.app/web/dashboard-dark.svg"
        alt="Dashboard illustration"
        width={2400}
        height={1800}
