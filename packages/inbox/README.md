...
```typescript
import { InboxAuthError, isInboxAuthError } from "@connorco/inbox/errors";
...
```typescript
import { InboxSyncError } from "@connorco/inbox/errors";
...
// Utility functions
import { isAuthenticationError } from "@connorco/inbox/utils";
```
