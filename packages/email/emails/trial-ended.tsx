...
export const TrialEndedEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Your Connor & Co trial has now ended, which means you have read-only access.`;
    ...
    <EmailThemeProvider preview={<Preview>{text}</Preview>}>
      ...
      >
        ...
        >
          ...
          >
            Your Connor & Co Trial Has Ended
          </Heading>
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Your Connor & Co trial has now ended, which means you have read-only
            access.
          </Text>
          <Text
          ...
          <Section className="text-center mt-[50px] mb-[50px]">
            <Button href="https://app.connorandco.vercel.app">Upgrade now</Button>
          </Section>
          <Text
            className={`text-[14px] ${themeClasses.text}`}
            style={{ color: lightStyles.text.color }}
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            If this is the last time we hear from you, thanks for giving Connor & Co
