...
export const TrialExpiringEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Just a quick reminder—your Connor & Co trial ends tomorrow. We hope you've had a great experience so far.`;
    ...
    <EmailThemeProvider preview={<Preview>{text}</Preview>}>
      ...
      >
        ...
        >
          ...
          >
            Your Connor & Co Trial is Expiring Soon
          </Heading>
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Just a quick reminder—your Connor & Co trial ends tomorrow. We hope
          ...
          <Section className="text-center mt-[50px] mb-[50px]">
            <Button href="https://app.connorandco.vercel.app/settings/billing">
              Claim your discount
            </Button>
          </Section>
          <Text
