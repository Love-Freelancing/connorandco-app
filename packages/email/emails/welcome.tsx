import { getEmailUrl } from "@connorco/utils/envs";
import {
  Body,
  Container,
  Heading,
...
export const WelcomeEmail = ({ fullName = "" }: Props) => {
  ...
  const text = `${firstName ? `Hi ${firstName}, ` : ""}Welcome to Connor & Co! I'm Pontus, one of the founders. It's really important to us that you have a great experience ramping up.`;
      ...
      >
        ...
        >
          ...
          <Text
            ...
            style={{ color: lightStyles.text.color }}
          >
            Welcome to Connor & Co! I'm Pontus, one of the founders.
            <br />
            <br />
            We built Connor & Co from over 10 years of running our own businesses,
            knowing firsthand the challenges that come with it. Connor & Co is built
            together with our customers, and it's important to us that you know
            we're here when you need us.
            <br />
            <br />
            Take your time to explore Connor & Co at your own pace. If you ever want
            to chat with us founders, you can schedule a time{" "}
            <Link
              href="https://cal.com/pontus-connorandco/15min"
