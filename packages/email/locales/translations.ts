  ...
  switch (locale) {
    case "en":
      return {
        ...
        "invite.subject": `${params?.invitedByName} invited you to the ${params?.teamName} team on Connor & Co`,
        "invite.preview": `Join ${params?.teamName} on Connor & Co`,
        "invite.title1": "Join",
        "invite.title2": "on",
    ...
    case "sv":
      return {
        ...
        "invite.subject": `${params?.invitedByName} bjöd in dig till ${params?.teamName} på Connor & Co`,
        "invite.preview": `Gå med i ${params?.teamName} på Connor & Co`,
