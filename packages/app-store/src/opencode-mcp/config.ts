...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect OpenCode to your Connor & Co data via MCP. Track time for clients from your terminal.",
  description: `Connect OpenCode to your Connor & Co account using the Model Context Protocol (MCP).
