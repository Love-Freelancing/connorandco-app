...
import { getTeamById } from "@connorco/db/queries";
    ...
    const blocks = [
      ...
      // Footer
      {
        ...
        elements: [
          {
            type: "mrkdwn" as const,
            text: "Upload receipts by sharing files in channels where Connor & Co is added. Data will be automatically extracted and matched to your transactions.",
          },
        ],
      },
    ];
