...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect Perplexity to your Connor & Co data with AI-powered search.",
  description: `Connect Perplexity to your Connor & Co account using the Model Context Protocol (MCP).
