...
export default {
  ...
  logo: Logo,
  short_description:
    "Connect Claude to your Connor & Co data via MCP. Get financial answers grounded in real numbers.",
  description: `Connect Claude to your Connor & Co account using the Model Context Protocol (MCP).
