...
export function formatWelcomeMessage(): string {
  const builder = new MessageBuilder();
  builder
    .header("Welcome to Connor & Co")
    .blank()
    .line("To connect your WhatsApp:")
    .bullet("Scan the QR code in your Connor & Co dashboard")
...
export function formatAlreadyConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You're already connected to Connor & Co.")
    .blank()
...
export function formatAlreadyConnectedToAnotherTeamError(
  ...
  builder
    ...
    .line("from the current team first in your Connor & Co dashboard.")
    .blank()
    .footer();
...
export function formatProcessingErrorMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Please try again or upload it directly in Connor & Co.")
    .blank();
...
export function formatNotConnectedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("Your WhatsApp is not connected to Connor & Co yet.")
    .blank()
    .line("Please scan the QR code in your Connor & Co dashboard to connect.")
    .blank();
...
export function formatMatchDeclinedMessage(): string {
  ...
  builder
    ...
    .blank()
    .line("You can review and match this receipt manually in Connor & Co.")
    .blank()
    .footer();
...
export function formatMatchActionErrorMessage(
  ...
  builder
    ...
    .blank()
    .line("Please try again or handle this in Connor & Co.")
    .blank()
    .footer();
