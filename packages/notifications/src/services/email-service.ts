...
import { shouldSendNotification } from "@connorco/db/queries";
import InsightsWeeklyEmail from "@connorco/email/emails/insights-weekly";
import InvoiceEmail from "@connorco/email/emails/invoice";
import InvoiceOverdueEmail from "@connorco/email/emails/invoice-overdue";
import InvoicePaidEmail from "@connorco/email/emails/invoice-paid";
import InvoiceReminderEmail from "@connorco/email/emails/invoice-reminder";
import TransactionsEmail from "@connorco/email/emails/transactions";
import TransactionsExportedEmail from "@connorco/email/emails/transactions-exported";
import UpcomingInvoicesEmail from "@connorco/email/emails/upcoming-invoices";
...
export class EmailService {
  ...
  async #buildEmailPayload(email: EmailInput): Promise<CreateEmailOptions> {
    ...
    const payload: CreateEmailOptions = {
      from: email.from || "Connor & Co <connor@connorandco.vercel.app>",
      to: recipients,
