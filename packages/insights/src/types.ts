/**
 * Core types for the @connorco/insights package
 */

// Import and re-export InsightPredictions from schema (single source of truth)
import type { InsightPredictions } from "@connorco/db/schema";
...
// InsightPredictions is defined in @connorco/db/schema - import from there
