...
AI-powered business insights generation for Connor & Co. This package provides smart metric selection, anomaly detection, and narrative content generation for periodic business summaries.
...
```typescript
import { createInsightsService } from "@connorco/insights";
import { db } from "@connorco/db/client";
...
```typescript
import { isTeamEnabledForInsights, getEnabledTeamIds } from "@connorco/insights";
