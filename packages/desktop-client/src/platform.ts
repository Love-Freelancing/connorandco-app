 ...
 *
 * - Production: "connorandco-app"
 * - Staging:    "connorandco-staging"
 * - Dev:        "connorandco-dev"
 */
export function getDesktopScheme(): string {
  return process.env.NEXT_PUBLIC_DESKTOP_SCHEME || "connorandco-app";
}
 ...
 *
 * @example
 * getDesktopSchemeUrl() // "connorandco://" in production, "connorandco-dev://" in dev
 */
 ...
 * ```typescript
 * // In production:
 * createDeepLink('dashboard');           // "connorandco://dashboard"
 * // In dev:
 * createDeepLink('transactions/123');    // "connorandco-dev://transactions/123"
 * ```
 */
