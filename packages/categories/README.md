...
```bash
npm install @connorco/categories
```
...
```typescript
import { CATEGORIES, getCategoryBySlug, getParentCategory } from '@connorco/categories';
...
```typescript
import { getTaxRateForCategory, getTaxTypeForCountry } from '@connorco/categories';
...
```typescript
import { getCategoryColor, CATEGORY_COLOR_MAP } from '@connorco/categories';
